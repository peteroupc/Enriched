...
if (index + 2 == endIndex - 1 && (str.charAt(index) & ~32) == 82 && (str.charAt(index + 1) & ~32) == 69 && (str.charAt(index + 2) & ~32) == 68) {
    ...
    1) & ~32) == 76 && (str.charAt(index + 2) & ~32) == 85 && (str.charAt(index + 3) & ~32)
         ...
         if (index + 3 < endIndex && (((str.charAt(index) >= 65 && str.charAt(index) <=
                ...
                48 &&
              str.charAt(index) <= 57)) && ((str.charAt(index + 1) >= 65 && str.charAt(index +
                1) <=
...
57)) && ((str.charAt(index + 2) >= 65 && str.charAt(index + 2) <= 70) || (str.charAt(index + 2)
  >= 97 && str.charAt(index + 2) <= 102) || (str.charAt(index + 2) >= 48 &&
...
if (index + 4 == endIndex - 1 && (str.charAt(index) == 44) && (((str.charAt(index + 1) >=
  65 && str.charAt(index + 1) <= 70) || (str.charAt(index + 1) >= 97
                    ...
                    &&
           str.charAt(index + 1) <= 102) || (str.charAt(index + 1) >= 48 && str.charAt(index +
...
70) || (str.charAt(index + 2) >= 97 && str.charAt(index + 2) <= 102) || (str.charAt(index + 2) >=
  48 && str.charAt(index + 2) <= 57)) && ((str.charAt(index + 3) >= 65 &&
                ...
                str.charAt(index + 3) <= 70) || (str.charAt(index + 3) >= 97 && str.charAt(index +
  ...
  int endIndex) {
            ...
            do {
                while (true) {
                    int indexTemp2 = index;
                    do {
         if (index + 1 < endIndex && str.charAt(index) == 60 && str.charAt(index + 1) == 60) {
...
<= 57) || (str.charAt(index) == 45) || (str.charAt(index) >= 97 && str.charAt(index) <= 122) ||
  ...
  commandStart)+(commandEnd - commandStart)).toLowerCase();
                    ...
                    p = ParseColor(p.toLowerCase(), 0, p.length());
                    if (p != null) {
