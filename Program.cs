...
namespace Enriched {
    ...
    if (index + 2 == endIndex - 1 && (str [index] & ~32) == 82 && (str
              [index +
            1] & ~32) == 69 && (str [index + 2] & ~32) == 68) {
                return str.Substring (index, endIndex - index);
            }
    if (index + 3 == endIndex - 1 && (str [index] & ~32) == 66 && (str
              [index +
    1] & ~32) == 76 && (str [index + 2] & ~32) == 85 && (str [index + 3] & ~32)
      ...
      70) || (str [index + 1] >= 97 && str [index + 1] <= 102) || (str
         ...
         str [index + 2] <= 70) || (str [index + 2] >= 97 && str [index + 2]
          ...
          ((str [index + 3] >= 65 && str [index + 3] <= 70) || (str [index +
                  3]
          ...
          if (index + 4 < endIndex && (str [index] == 44) && (((str [index +
                  1]
      >= 65 && str [index + 1] <= 70) || (str [index + 1] >= 97 && str
                  [index +
             1] <= 102) || (str [index + 1] >= 48 && str [index + 1] <= 57))
                  &&
          ((str [index + 2] >= 65 && str [index + 2] <= 70) || (str [index +
                  2]
                >= 97 && str [index + 2] <= 102) || (str [index + 2] >= 48 &&
          str [index + 2] <= 57)) && ((str [index + 3] >= 65 && str [index +
                  3]
                <= 70) || (str [index + 3] >= 97 && str [index + 3] <= 102) ||
         (str [index + 3] >= 48 && str [index + 3] <= 57)) && ((str [index +
                  4]
      >= 65 && str [index + 4] <= 70) || (str [index + 4] >= 97 && str
        ...
        private static int SkipFont (string str, int index, int endIndex) {
           ...
           if (index < endIndex && ((str [index] >= 48 && str [index] <= 57)
             ...
             str [index] <= 56319) && (str [index + 1] >= 56320 && str
                      [index +
                    1] <= 57343))) {
                    indexTemp3 += 2; break;
                    }
          ...
          endIndex) {
            ...
            do {
                while (true) {
                    int indexTemp2 = index;
                    do {
               if (index + 1 < endIndex && str [index] == 60 && str [index +
                      1]
                    == 60) {
                ...
                57) || (str [index] == 45) || (str [index] >= 97 && str
                    ...
                    indexTemp3 = index;
                    do {
                  if (index + 1 < endIndex && str [index] == 13 && str
                      [index +
                    1] == 10) {
                    indexTemp3 += 2; break;
                    }
